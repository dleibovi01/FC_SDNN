...
//    data->at(0) = circshift(*fluxL, -2);
//    data[1] = circshift(*fluxL, -1);
//    data[2] = circshift(*fluxL, 1);
//    data[3] = circshift(*fluxL, 2);


//    // Polynomials
//    data[4] = (1.0/6.0)*(5.0*data[1] - data[0] + 2.0*(*fluxL));
//    data[5] = (1.0/6.0)*(2.0*data[1] + 5.0*(*fluxL) - data[2]);
//    data[6] = (1.0/6.0)*(11.0*(*fluxL) - 7.0*data[2] + 2.0*data[3]);


//    // Smooth indicators
//    data[7] = (13.0/12.0)*sqr(data[0] - 2.0*data[1] + (*fluxL))
//       + 0.25*sqr(data[0] - 4.0*data[1] + 3.0*(*fluxL));
//    data[8] = (13.0/12.0)*sqr(data[1] - 2.0*(*fluxL) + data[2])
//       + 0.25*sqr(data[1] - data[2]);
//    data[9] = (13.0/12.0)*sqr((*fluxL) - 2.0*data[2] + data[3])
//       + 0.25*sqr(3*(*fluxL) - 4.0*data[2] + data[3]);


//    // tau5
//    data[10] = abs(data[7] - data[9]);


//    // alpha weights
//    data[7] = d0p*(1.0 + data[10]/(data[7] + epsilon));
//    data[8] = d1p*(1.0 + data[10]/(data[8] + epsilon));
//    data[9] = d2p*(1.0 + data[10]/(data[9] + epsilon));
//    data[10] = data[7] + data[8] + data[9];
...
//    // Numerical flux at cell boundary
//    fluxL->setFlow((data[7]*data[4] + data[8]*data[5] + data[9]*data[6]).getFlow());
...
//    // Rotating vectors
//    data[0] = circshift(*fluxR, -2);
//    data[1] = circshift(*fluxR, -1);
//    data[2] = circshift(*fluxR, 1);
//    data[3] = circshift(*fluxR, 2);

//    // Polynomials
//    data[4] = (1.0/6.0)*(2.0*data[0] - 7.0*data[1] + 11.0*(*fluxR));
//    data[5] = (1.0/6.0)*(5.0*(*fluxR) - data[1] + 2.0*data[2]);
//    data[6] = (1.0/6.0)*(2.0*(*fluxR) + 5.0*data[2] - data[3]);

//    // Smooth indicators
//    data[7] = (13.0/12.0)*sqr(data[0] - 2.0*data[1] + (*fluxR))
//       + 0.25*sqr(data[0] - 4.0*data[1] + 3.0*(*fluxR));
//    data[8] = (13.0/12.0)*sqr(data[1] - 2.0*(*fluxR) + data[2])
//       + 0.25*sqr(data[1] - data[2]);
//    data[9] = (13.0/12.0)*sqr((*fluxR)- 2.0*data[2] + data[3])
//       + 0.25*sqr(3*(*fluxR) - 4.0*data[2] + data[3]);

//    // tau5
//    data[10] = abs(data[7] - data[9]);

//    // alpha weights
//    data[7] = d0n*(1.0 + data[10]/(data[7] + epsilon));
//    data[8] = d1n*(1.0 + data[10]/(data[8] + epsilon));
//    data[9] = d2n*(1.0 + data[10]/(data[9] + epsilon));
//    data[10] = data[7] + data[8] + data[9];
...
//    // Numerical flux at cell boundary
//    fluxR->setFlow((data[7]*data[4] + data[8]*data[5] + data[9]*data[6]).getFlow());
